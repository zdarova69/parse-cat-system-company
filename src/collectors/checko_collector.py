...
class CheckoCollector(BaseCollector):
        ...
        for search_query in search_queries:
            ...
            try:
                ...
                if not company_links:
                    company_links = soup.find_all('a', href=re.compile(r'/ul/\d+'))
    ...
    def _parse_company_page(self, url: str) -> Dict:
        """
        Парсит страницу компании на checko.ru.
        ...
        try:
            ...
            # Извлекаем название
            name_elem = soup.find('h1', class_=re.compile(r'company-name|org-name'))
            if not name_elem:
